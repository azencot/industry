...
6. Forecasting only: [`Forecasting/prep-plan.md`](Forecasting/prep-plan.md); notes under [`Forecasting/notes/`](Forecasting/notes/) (session debriefs live here, not under FinTech/SCOT/GenAI)
