...
- **Story format locked:** DOC sections (Title · Outline · Ecosystem · Issue · Objectives · Actions · Results · Learnings) + Interview notes with **~6–7 min spoken** primary script and 90s backup. See [`Amazon_FinTech/stories/README.md`](../stories/README.md).
...
**Raw material captured:** metrics and per-task table folded into [`ownership_killed-tr-synthetic.md`](../stories/ownership_killed-tr-synthetic.md)
...
- **Dive Deep:** Anchor C audit drafted — [`dive-deep_tsrbench-reasoning-audit.md`](../stories/dive-deep_tsrbench-reasoning-audit.md). Ownership handoff only; 3 regimes; ~+5 pp 0.8B preliminary.
...
> Read `@Files Amazon_FinTech/debrief/2026-06-22_day3-lp-stories.md` and `@Files Amazon_FinTech/anchor-cheat-sheet.md` (Anchor B). Draft **Ownership** story DOC L6: killed TR bucket mixes — tiered eval, slice regression, IC artifacts. Baseline: stock metrics only where relevant; no internal config names in spoken script.
