...
3. **Use DOC template** — [`Amazon_FinTech/stories/README.md`](../../Amazon_FinTech/stories/README.md): Title · Outline · Ecosystem · Issue · Objectives · Actions · Results · Learnings.
...
6. **Critique** using DOC quality bar + **DOC AI checklist** in [`stories/README.md`](../../Amazon_FinTech/stories/README.md):
...
8. **Persist** — save or update `Amazon_FinTech/stories/{lp-slug}_{title}.md` using full DOC sections; mark LP ready in `stories/README.md` table.
