...
| | |
|---|---|
| **Role** | [Machine Learning Research Scientist - Health AIML](https://jobs.apple.com/en-us/details/200670570-3337/machine-learning-research-scientist-health-aiml?team=MLAI) |
| **Req** | 200670570-3337 |
...
| **2026-08-31** | High-ROI **coding** (now 8) | Pad contingency + slot (2) primitives. #7 intervals · #8 streaming top-k added 2026-09-03. [`coding/`](coding/). Not LeetCode; not [`code/`](code/) tech-screen worksheets. |
...
| **2026-09-03** | **4-day final plan** (second cycle) | Fri 9/4–Mon 9/7. Transfer, not recall. [`2026-09-03_four-day-final-plan.md`](2026-09-03_four-day-final-plan.md). Friday: [`chung-cheng advanced`](2026-09-04_chung-cheng-advanced.md) · [`haraldur advanced`](2026-09-04_haraldur-advanced.md) · coding #7/#8 |
...
Research lead for **multimodal / representation models** over **health & fitness** data — **Guillermo (private, 2026-08-22):** applied ML toward a **~1 year product** target, not an open-ended FM lab. Still: foundational tech that must ship, with **safe** LLM deployment mindset. Do not attribute this on loop.

## People

### Confirmed on this req
...
Apple rarely labels **Health AIML** vs **Health AI** cleanly; prefer Tyler / HM naming over cold outreach mid-loop. **Do not email on-site interviewers.**
...
**Outreach:** Do **not** email Shirley, Feng, or the five on-site interviewers. Tyler / the plan email own scheduling. **Kimmel → Sapiro (2026-08-22):** Guillermo **replied** — [`2026-08-22_kimmel-sapiro-outreach.md`](2026-08-22_kimmel-sapiro-outreach.md). One clarification already sent. **No third email.** Do not name-drop papers. **Raja:** wrong org for this req.
