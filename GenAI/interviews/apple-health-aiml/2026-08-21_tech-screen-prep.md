...
| **Sun** | Day 2 — multimodal | ~5 | **Taught.** Recap (read to recall): [`../../notes/2026-08-23_day2-multimodal-recap.md`](../../notes/2026-08-23_day2-multimodal-recap.md). Worksheet: [`code/day2_multimodal.py`](code/day2_multimodal.py). Sat table: [`../../notes/2026-08-22_multimodal-fusion-lockin.md`](../../notes/2026-08-22_multimodal-fusion-lockin.md) |
| **Mon** | Day 3 — SFT + debug + mock | ~4 | **Taught Q1–Q11.** SFT = teacher force, no train decode. Q12 **not spoken.** Debrief: [`../../notes/2026-08-24_day3-sft-mock.md`](../../notes/2026-08-24_day3-sft-mock.md). Worksheet: [`code/day3_broken_attention.py`](code/day3_broken_attention.py) |
| **Tue AM** | retrieval only | 15 min | **First: Q12 aloud** (Day 2 recap §9). Then Q1, Q6, Q10, Q12; then stop |
