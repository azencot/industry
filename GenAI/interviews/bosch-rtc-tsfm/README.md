# Bosch RTC-NA — Multimodal / TSFM foundation models

| | |
|---|---|
| **Active req (from HM email)** | [AI Research Scientist — Multimodal Foundational Models](https://jobs.smartrecruiters.com/BoschGroup/744000139447918-ai-research-scientist-multimodal-foundational-models-) |
| **You first looked at** | [Senior AI Research Scientist — Time-Series Foundational Models](https://jobs.smartrecruiters.com/BoschGroup/744000135345769-senior-ai-research-scientist-time-series-foundational-models?trid=2d92f286-613b-4daf-9dfa-6340ffbecf73) (`744000135345769`) |
...
JDs are nearly identical. On the call, use **her** title: Research Scientist, Multimodal Foundational Models. Do not correct her to “Senior TSFM.”
...
IC research scientist building **multimodal foundation models** over industrial sensors (audio, vibration, radar, IMU, telemetry) **plus vision**, for robotics / ADAS / physical AI — classify, describe, fuse; not a forecast-only mandate.
...
| Put here | Do not use |
|----------|------------|
| This HM screen | [`Forecasting/`](../../../Forecasting/) (Chronos vs LightGBM) |
| Sensor FMs + vision | Apple Health scripts without retargeting |
