...
Prep for **generative AI / LLM** applied scientist and related industry roles (RAG, agents, eval, production GenAI systems). **Not** forecasting — that lives in [`Forecasting/`](../Forecasting/). **Not** Amazon FinTelligence PS1 loop scaffolding — that stays in [`Amazon_FinTech/`](../Amazon_FinTech/) (reuse `/ml-deep-dive` and shared experience profile when useful).
...
| 2026-08-12 | Apple Health AIML HM 3C training-run detail | [`interviews/apple-health-aiml/2026-08-12_hm-3c-training-run.md`](interviews/apple-health-aiml/2026-08-12_hm-3c-training-run.md) — 9B/27B + 8B champion numbers, ablations, kill, infra |
...
| Track | Use for |
|-------|---------|
| **This folder (`GenAI/`)** | GenAI / LLM role interviews and prep |
