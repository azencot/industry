...
| 2026-08-22 | Multimodal fusion lock-in (Day 2, partial) | [`notes/2026-08-22_multimodal-fusion-lockin.md`](notes/2026-08-22_multimodal-fusion-lockin.md) — projector = spaces; concat vs xattn vs unified; `-100` ≠ attn; first-text still attends to last-vis; concat does not block text shortcut; CLIP / Q12 not started |
